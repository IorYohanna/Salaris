        ...
        <div className="max-w-4xl mx-auto flex justify-center items-start pt-6 pb-10 animate-fadeIn">
            <div className="bg-white border border-[#A67C52] rounded-xl p-8 w-full max-w-2xl shadow-3xl shadow-gray-100">
                ...
                <div className="mb-8 text-center">
                    <h2 className="text-2xl font-bold text-[#876245]">Nouvel Enseignant</h2>
                    <p className="text-gray-500 text-sm mt-1">Remplissez les informations pour l'enregistrement</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block mb-2 text-sm font-semibold text-gray-700">Matricule</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block mb-2 text-sm font-semibold text-gray-700">Taux horaire (€)</label>
                            <input
                                type="number"
                                step="0.01"
                                required
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-semibold text-gray-700">Nombre d'heures</label>
                            <input
                                type="number"
                                step="0.5"
                                required
                    ...
                    <div className="bg-[#876245]/5 border-2 shadow-lg border-dashed border-[#D4A574]/30 rounded-2xl p-5 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-xs font-bold text-[#876245] uppercase tracking-wider">Estimation Prestation</p>
                                <p className="text-gray-500 text-xs">Calcul basé sur le taux et les heures</p>
                            </div>
                        </div>
